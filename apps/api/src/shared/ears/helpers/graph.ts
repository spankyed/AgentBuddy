...
// /* 1 ▸ Find all descendants/ancestors */
// const allChildren = descendants(nodeId, EARS.RelKind.CONTAINS);
// const allParents = ancestors(nodeId, EARS.RelKind.CONTAINS);

// /* 2 ▸ Find root of hierarchy */
// const root = rootParent(nodeId, EARS.RelKind.CONTAINS);

// /* 3 ▸ Guard before linking (prevent cycles) */
// if (wouldCreateCycle(source, target, [
//       EARS.RelKind.BLOCKS,
//       EARS.RelKind.DEPENDS_ON,
//     ])) throw new Error("Would create cycle!");

// /* 4 ▸ Create symmetric relationship */
// linkSymmetric(doc1, doc2, EARS.RelKind.RELATES_TO);

// /* 5 ▸ Produce build order */
// const ordered = topoSort([rootId], EARS.RelKind.DEPENDS_ON);

// /* 6 ▸ Explain why A blocks Z */
// const path = shortestPath(A, Z, [
//   EARS.RelKind.BLOCKS,
//   EARS.RelKind.DEPENDS_ON,
// ]);

// /* 7 ▸ Find tasks with no subtasks */
// const endLeaves = leaves(EARS.RelKind.CONTAINS);

// /* 8 ▸ Find common folder */
// const lca = lowestCommonAncestor(doc1, doc2);

// /* For use in transaction.ts */
