...
// // type AttributeValue = ECS.AttributeDataForType;
...
// function updateAttribute(entityID: EntityID, attributeType: string, newValue: AttributeValue, index = 0) {
//   if (!attributeStore[attributeType]) {
//     attributeStore[attributeType] = {};
//   }
...
//   }
// }
// function removeAttribute(entityID: EntityID, attributeType: string, index = 0): void {
...
// function getAttributesByType(attributeType: string): AttributeTypeMap {
//   return attributeStore[attributeType] || [];
// }

// function getFirstAttributeByType(attributeType: string): AttributeValue | null {
//   const attributes: AttributeTypeMap = getAttributesByType(attributeType);
//   const entityID = Object.keys(attributes)[0];
...
// function getAttribute(entityID: EntityID, attributeType: string, index = 0): AttributeValue | null {
//   const attributes = getAttributes(entityID, attributeType);
...
// function queryEntitiesByRelationTo(relationType: string, entityID: EntityID, isSource?: boolean): (EntityID | undefined)[] {
...
//       if (index[entityID]) {
//         for (const relationEntityID in index[entityID]) {
//           const relationDetails = getRelation(relationEntityID);
