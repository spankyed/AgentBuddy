<template>
  ...
  <div class="absolute z-10 ml-1 pointer-events-none bottom-4">
    <Button
...
const content = useSelector(actor, (state) => state.context.currentThread?.canvasContent || { contentType: 'text', content: '' });
