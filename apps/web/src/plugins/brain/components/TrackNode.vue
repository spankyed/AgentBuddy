<template>
  <div 
    ...
    :class="[
      nodeClasses,
      {
        'ring-2 ring-blue-500': data.isCurrentNode,
        'cursor-pointer hover:ring-2 hover:ring-purple-500': data.isFlowNode,
      }
    ]"
  >
    ...
    <!-- Flow indicator -->
    <div v-if="data.isFlowNode" class="absolute -top-2 -right-2">
    ...
    <!-- Status indicator for root nodes -->
    <div v-if="data.isRoot && data.status" class="absolute -top-2 -left-2">
