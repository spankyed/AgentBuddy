<template>
  <div class="h-full overflow-x-hidden overflow-y-auto bg-neutral-900">
    <!-- Tree Content -->
    <div v-if="tnodeTree && tnodeTree.length > 0" class="p-1">
      <TNodeTreeItem
    ...
    <div v-else class="flex flex-col items-center justify-center h-full px-4 text-center">
      <div class="flex items-center justify-center w-12 h-12 mb-3 rounded-lg bg-neutral-900">
