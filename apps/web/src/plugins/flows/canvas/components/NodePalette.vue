  ...
  <div class="p-3">
    <div class="mt-3 space-y-1">
      <button
        ...
        :key="item.type"
        class="w-full group flex items-center gap-3 px-3 py-2 bg-neutral-800 rounded-lg text-neutral-100 cursor-grab text-sm transition-all duration-200 hover:bg-neutral-700 hover:border-neutral-600 hover:shadow-sm active:cursor-grabbing active:scale-[0.98]"
        draggable="true"
