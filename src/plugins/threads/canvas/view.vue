  ...
  <div class="max-w-5xl px-6 py-4 mx-auto space-y-6 root-container">
    <div class="p-4 space-y-6">
      ...
      <div class="flex flex-col gap-4 md:flex-row">
        <div class="flex-1">
          <label class="block mb-1 text-sm font-medium text-neutral-500">Title</label>
          <input
            v-model="title"
            type="text"
        ...
        <div class="w-full md:w-40">
          <label class="block mb-1 text-sm font-medium text-neutral-500">Type</label>
          <select
            v-model="type"
            class="w-full px-3 py-2 text-sm border rounded bg-neutral-900 border-neutral-700 text-neutral-200 focus:outline-none focus:ring-1 focus:ring-primary-600"
          >
      ...
      <!-- Context -->
      <div>
        <label class="block mb-2 text-sm font-medium text-neutral-500">Context</label>
      ...
      <!-- Threads list -->
      <div>
        <label class="block mb-2 text-sm font-medium text-neutral-500">Related Threads</label>
      ...
      <!-- Tags list -->
      <div>
        <label class="block mb-2 text-sm font-medium text-neutral-500">Tags</label>
        <div class="flex flex-wrap gap-2">
          <button
            type="button"
            @click="addTag"
