...
### Fixes
-  use correct env var name (GITHUB_TOKEN) for ripgrep postinstall auth
...
### Fixes
-  revert version number to 0.0.0 in package.json
-  app hangs on splash when launched from Finder
-  revert version number to 0.0.0 in package.json
-  remove early return in closeSplashWithDelay for testing purposes
-  correct environment variable name in postbuild script
-  revert version number to 0.0.0 in package.json
-  include @app/api in root deps so electron-builder bundles its dependencies
-  update splash screen background to a radial gradient
-  allow dev and production Electron instances to coexist
-  adjust splash screen styles and enhance loading bar dimensions
-  update splash screen styles and replace loading indicator with loading bar
...
- update icon assets
- track new logos
- rename logo assets in SVG
- docs: add post-mortem for production app crash due to missing @ai-sdk dependencies
- update icons
- little padding
- stretch logo to edges
- better center logo
- Revert "docs: add troubleshooting guide for broken production Electron app build"
- docs: add troubleshooting guide for broken production Electron app build
- ix: ProcessManager.isRunning() returns true for crashed processes
- update defs
- update defs
- update defs
- update defs
