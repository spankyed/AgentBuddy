...
// Same story as the source board shot, but with the window entrance pinned
// so the full UI is steady from the first frame.
export function SimpleBoardScene({frame, variant}: {frame: number; variant?: 'landscape' | 'square'}) {
