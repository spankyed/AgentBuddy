// Builds @abuddy/ears's dist/: tsc-compiled ESM and declarations (no source maps: src doesn't ship). package.json is the
...
async function main(): Promise<void> {
  ...
  bareImports.assertDeclared(pkg, 'packages/abuddy-ears/package.json');
...
await runPackageBuild('@abuddy/ears', main);
