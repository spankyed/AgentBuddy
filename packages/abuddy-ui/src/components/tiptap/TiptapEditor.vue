...
import { createImageHandlers } from './composables/createImageHandlers.js'
import { createEditorClickHandler, createViewerClickHandler } from './composables/createEditorClickHandler.js'
import { useSubDocumentTracking } from './composables/useSubDocumentTracking.js'
import { createKeyboardHandler } from './composables/createEditorKeyboard.js'
import { useActorSystem } from '@abuddy/sdk/fe'
import { setEditorSystem } from './editor-system.js'
...
const isSuggestionActive = (view: import('@tiptap/pm/view').EditorView) =>
  tiptapPlugins.some(p => p.isSuggestionActive?.(view.state))
