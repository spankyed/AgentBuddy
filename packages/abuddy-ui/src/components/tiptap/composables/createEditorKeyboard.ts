...
interface KeyboardOptions {
  ...
  isSuggestionActive?: (view: EditorView) => boolean
  emit: {
    submit: () => void
    focusTitle: () => void
    historyPrev: () => void
...
export function createKeyboardHandler({ cfg, getEditor, getInHistoryMode, getPauseAvailable, isSuggestionActive, emit }: KeyboardOptions) {
