...
export interface PackRegistryView extends PackExtensionsView {
  ...
  /**
   * The refs of every installed feature that declares settings: the registered packs', and those of installed packs
   * that aren't running (disabled, or failed to load), whose settings stay theirs
   */
