// The repositories of the SDK's entities: the flow model, step executions, actions and prompts, and the trash
// any entity can be moved to. The entities' types are in `@abuddy/sdk/types`.
...
export { trash, type TrashFields, type Trashed } from './trash.ts';
