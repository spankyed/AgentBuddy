...
type BaseEntity = _abuddy_sdk.BaseEntity;
...
declare namespace EARS {
    ...
    type RoleKind = _abuddy_sdk.EARS.RoleKind;
    ...
    type AttrKind = _abuddy_sdk.EARS.AttrKind;
    type Blueprint = _abuddy_sdk.EARS.Blueprint;
    type RelationDetail = _abuddy_sdk.EARS.RelationDetail;
    type AttributePayloads = _abuddy_sdk.EARS.AttributePayloads;
    type AttributeValue<K extends AttrKind = AttrKind> = _abuddy_sdk.EARS.AttributeValue<K>;
    type AttributeTypeMap = _abuddy_sdk.EARS.AttributeTypeMap;
    type AttributeStore = _abuddy_sdk.EARS.AttributeStore;
}
...
declare const brainQueries: {
    ...
    } & Pick<TNodeEntity & _abuddy_sdk.BaseEntity & {
        id: `${string}-${string}` & {
            readonly __entity?: "TNode" | undefined;
        };
...
declare const threadQueries: {
    ...
    } & Pick<MessageEntity & _abuddy_sdk.BaseEntity & {
        id: `${string}-${string}` & {
            readonly __entity?: "Message" | undefined;
        };
