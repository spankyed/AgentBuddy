...
import { isEditableDiff, type OpenFile, type TerminalTab, type TabGroup } from '@/plugins/code/fe/state'
import { nativeVideoExtensions } from '@/plugins/code/fe/utils/file-icons'
import type { ActionTab } from '@/plugins/code/fe/features/actions/state'
import type { PromptTab } from '@/plugins/code/fe/features/prompts/state'
import type { GitDiff } from '@/plugins/code/fe/features/commit/state'
