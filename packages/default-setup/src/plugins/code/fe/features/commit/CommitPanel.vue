...
import { MENU_ITEM_CLASS, MENU_ITEM_DANGER_CLASS } from '@/plugins/code/fe/features/explorer/constants'
import GitFileItem from '@/plugins/code/fe/features/commit/GitFileItem.vue'
...
import CommitLogSection from '@/plugins/code/fe/features/commit/CommitLogSection.vue'
