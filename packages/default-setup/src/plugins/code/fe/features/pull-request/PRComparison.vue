...
import FileTreeSkeleton from '@/plugins/code/fe/features/pull-request/FileTreeSkeleton.vue'
import FileTree from '@/plugins/code/fe/features/pull-request/FileTree.vue'
