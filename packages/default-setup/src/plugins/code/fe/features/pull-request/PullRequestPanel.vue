...
import PRSelector from '@/plugins/code/fe/features/pull-request/PRSelector.vue'
import PRComparison from '@/plugins/code/fe/features/pull-request/PRComparison.vue'
import CreatePRForm from '@/plugins/code/fe/features/pull-request/CreatePRForm.vue'
import PRInfo from '@/plugins/code/fe/features/pull-request/PRInfo.vue'
import PRComments from '@/plugins/code/fe/features/pull-request/PRComments.vue'
import PRActionBar from '@/plugins/code/fe/features/pull-request/PRActionBar.vue'
