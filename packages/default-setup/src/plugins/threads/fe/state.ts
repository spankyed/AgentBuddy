...
import type { ThreadTabGroup, TabGroupColor } from '@/plugins/threads/fe/canvas/agent/tabs/types';
import { getNextAvailableColor } from '@/plugins/threads/fe/canvas/agent/tabs/types';
import { saveThreadTabGroups, loadThreadTabGroups } from '@/plugins/threads/fe/canvas/agent/tabs/tab-groups';
