// The logs system's contract: what it receives, what its own children send it, what it sends its plugin,
...
import type { IncomingLogEvents, LogsContext, LogsInternalEvents, OutgoingLogsEvents } from './types.ts';
