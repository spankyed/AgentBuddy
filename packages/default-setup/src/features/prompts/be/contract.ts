// The prompts system's contract: what it receives, what its own children send it, what it sends its plugin,
...
import type { IncomingPromptEvents, OutgoingPromptEvents } from './types.ts';
