...
export type { AgentSettings, AgentMode, AgentPhase, QuickPrompt, CommandItem } from '@/features/settings/be/types';

// Re-export ThreadTagOption for backward compat (was re-exported from settings)
export type { ThreadTagOption } from '@/features/settings/be/types';
