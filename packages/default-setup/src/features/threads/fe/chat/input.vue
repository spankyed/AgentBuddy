...
import type { AgentThreadData, AgentMode, MessageReferences, QuickPrompt } from '@/registries/types'
import { commandSuggestionPluginKey } from '../../../../registries/tiptap/command-suggestion-plugin'
...
const commandHighlight = computed(() => {
  ...
  const state = commandSuggestionPluginKey.getState(editor.state)
