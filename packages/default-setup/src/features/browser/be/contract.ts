// The browser system's contract: what it receives, what its own children send it, what it sends its plugin,
...
import type { BrowserContext, IncomingBrowserEvents, OutgoingBrowserEvents } from './types.ts';
