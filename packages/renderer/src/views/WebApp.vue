...
import CanvasArea from '@/views/layout/canvas-area.vue'
import ChatArea from '@/views/layout/chat-area.vue'
import InspectionPanel from '@/views/layout/inspection-panel.vue'
...
import Router from '@/views/layout/router.vue'
