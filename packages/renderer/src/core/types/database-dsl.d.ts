// Generated ambient declarations for DatabaseDSL
declare namespace DatabaseDSL {
    ...
    declare function addRelation(src: EARS.EntityId, kind: string, tgt: EARS.EntityId, info?: unknown): `Agent-${string}` | `Brain-${string}` | `Message-${string}` | `Thread-${string}` | `Tag-${string}` | `Relation-${string}` | `Artifact-${string}` | `Flow-${string}` | `Node-${string}` | `TNode-${string}` | `Prompt-${string}` | `Action-${string}` | `Document-${string}` | `Collection-${string}` | `SearchIndex-${string}` | `Terminal-${string}` | `Directory-${string}`;
    ...
    declare const queryEntitiesByRelationTo: (relKind: string, id: EARS.EntityId, asSource?: boolean) => (`Agent-${string}` | `Brain-${string}` | `Message-${string}` | `Thread-${string}` | `Tag-${string}` | `Relation-${string}` | `Artifact-${string}` | `Flow-${string}` | `Node-${string}` | `TNode-${string}` | `Prompt-${string}` | `Action-${string}` | `Document-${string}` | `Collection-${string}` | `SearchIndex-${string}` | `Terminal-${string}` | `Directory-${string}`)[];
    ...
    declare const bp: (entity: EARS.Entity) => {
        attr(k: string, v: unknown): any;
        grant(r: EARS.RoleKind): any;
        ensure(r: EARS.RoleKind): any;
        link(kind: EARS.RelKind, target: Blueprint | EARS.EntityId, info?: unknown): any;
        build(): Blueprint;
    };
