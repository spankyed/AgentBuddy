// Generated ambient declarations for ActionDSL
declare global {
    const params: ActionParams;
    const services: Services;
    const z: typeof zod.z;
}
declare namespace ActionDSL {
    ...
    declare const ___src_services_browser_Browser: typeof Browser;
    declare const ___src_services_browser_BrowserContext: typeof BrowserContext;
    type ___src_services_browser_BrowserService = BrowserService;
    declare const ___src_services_browser_BrowserService: typeof BrowserService;
    type ___src_services_browser_LaunchOptions = LaunchOptions;
    declare const ___src_services_browser_Page: typeof Page;
    declare const ___src_services_browser_chromium: typeof chromium;
    declare const ___src_services_browser_createBrowser: typeof createBrowser;
    declare const ___src_services_browser_firefox: typeof firefox;
    declare const ___src_services_browser_webkit: typeof webkit;
    declare namespace ___src_services_browser {
        export { ___src_services_browser_Browser as Browser, ___src_services_browser_BrowserContext as BrowserContext, ___src_services_browser_BrowserService as BrowserService, ___src_services_browser_Page as Page, ___src_services_browser_chromium as chromium, ___src_services_browser_createBrowser as createBrowser, ___src_services_browser_firefox as firefox, ___src_services_browser_webkit as webkit };
        export type { ___src_services_browser_LaunchOptions as LaunchOptions };
    }
    ...
    type ___src_services_database_SafeLinkOptions = SafeLinkOptions;
    declare const ___src_services_database_countEntities: typeof countEntities;
    declare const ___src_services_database_createEntityWithDefaults: typeof createEntityWithDefaults;
    declare const ___src_services_database_createRelation: typeof createRelation;
    declare const ___src_services_database_exists: typeof exists;
    declare const ___src_services_database_findAll: typeof findAll;
    declare const ___src_services_database_findById: typeof findById;
    declare const ___src_services_database_findByIdWithFields: typeof findByIdWithFields;
    declare const ___src_services_database_findFirst: typeof findFirst;
    declare const ___src_services_database_findFirstWithRole: typeof findFirstWithRole;
    declare const ___src_services_database_findWhere: typeof findWhere;
    declare const ___src_services_database_findWithFields: typeof findWithFields;
    declare const ___src_services_database_findWithRole: typeof findWithRole;
    declare const ___src_services_database_grantRole: typeof grantRole;
    declare const ___src_services_database_prepareEntity: typeof prepareEntity;
    declare const ___src_services_database_qx: typeof qx;
    declare const ___src_services_database_removeRelation: typeof removeRelation;
    declare const ___src_services_database_revokeRole: typeof revokeRole;
    declare const ___src_services_database_tx: typeof tx;
    declare const ___src_services_database_updateEntity: typeof updateEntity;
    declare namespace ___src_services_database {
        export { ___src_services_database_EARS as EARS, ___src_services_database_countEntities as countEntities, ___src_services_database_createEntityWithDefaults as createEntityWithDefaults, ___src_services_database_createRelation as createRelation, ___src_services_database_exists as exists, ___src_services_database_findAll as findAll, ___src_services_database_findById as findById, ___src_services_database_findByIdWithFields as findByIdWithFields, ___src_services_database_findFirst as findFirst, ___src_services_database_findFirstWithRole as findFirstWithRole, ___src_services_database_findWhere as findWhere, ___src_services_database_findWithFields as findWithFields, ___src_services_database_findWithRole as findWithRole, ___src_services_database_grantRole as grantRole, ___src_services_database_prepareEntity as prepareEntity, ___src_services_database_qx as qx, ___src_services_database_removeRelation as removeRelation, ___src_services_database_revokeRole as revokeRole, ___src_services_database_tx as tx, ___src_services_database_updateEntity as updateEntity };
        export type { ___src_services_database_SafeLinkOptions as SafeLinkOptions };
    }
    type Simplify<T> = {
        [K in keyof T]: T[K];
    } & {};
        ...
        readonly incoming: readonly [
            ...
            zod.ZodObject<{
                ...
                linkedThreads: zod.ZodOptional<zod.ZodArray<zod.ZodObject<{
                    id: zod.ZodString;
                    relation: zod.ZodUnion<[
                        zod.ZodLiteral<"parent_of">,
                        zod.ZodLiteral<"blocks">,
                        zod.ZodLiteral<"blocked_by">,
                        zod.ZodLiteral<"duplicates">
                    ]>;
            ...
            zod.ZodObject<{
                ...
                systemId: zod.ZodLiteral<"library">;
                name: zod.ZodString;
                content: zod.ZodArray<zod.ZodUnion<[
                    zod.ZodObject<{
    ...
    declare namespace ___src_services_event_emitter {
        export { ___src_services_event_emitter_onIncoming as onIncoming, ___src_services_event_emitter_onOutgoing as onOutgoing, ___src_services_event_emitter_sendToPlugin as sendToPlugin, ___src_services_event_emitter_sendToSystem as sendToSystem, };
    }
    ...
    declare const ___src_services_llm_CoreMessage: typeof CoreMessage;
    type ___src_services_llm_ModelConfig = ModelConfig;
    type ___src_services_llm_Provider = Provider;
    declare const ___src_services_llm_generateObject: typeof generateObject;
    declare const ___src_services_llm_generateText: typeof generateText;
    declare const ___src_services_llm_streamObject: typeof streamObject;
    declare const ___src_services_llm_streamText: typeof streamText;
    declare namespace ___src_services_llm {
        export { ___src_services_llm_CoreMessage as CoreMessage, ___src_services_llm_generateObject as generateObject, ___src_services_llm_generateText as generateText, ___src_services_llm_streamObject as streamObject, ___src_services_llm_streamText as streamText };
        export type { ___src_services_llm_ModelConfig as ModelConfig, ___src_services_llm_Provider as Provider };
    }
    declare const services: {
        ...
        llm: typeof ___src_services_llm;
        emitter: typeof ___src_services_event_emitter;
        database: typeof ___src_services_database;
        prompt: PromptService;
        action: ActionService;
        library: LibraryService;
        browser: typeof ___src_services_browser;
        repository: {
