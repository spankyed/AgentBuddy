...
export const tourSteps: TourStep[] = [
  ...
  },
  {
    ...
    content: 'Each icon in the toolbar represents a different plugin or tool you and the assistant can use.',
  ...
  },
  {
    ...
    title: 'Canvas Area',
    content: 'The canvas is where plugins and the assistant display content. It is adapted based on the active plugin.',
    setupActions: [],
  },
  {
    id: 'chat',
    targetId: 'chat-area',
    title: 'Chat Area',
    content: 'This is where you chat with the assistant, duh. Type messages, send commands, and receive responses from your assistant.',
    setupActions: [],
  },
  {
    id: 'inspection',
    ...
    content: 'The inspection panel shows contextual information like event traces from the brain. Plugins may also display some additional plugin details in the inspection panel.',
  ...
  // ========================================
  {
    ...
    content: 'A tool to manage your conversations and work-item threads.',
    tooltipPosition: 'right',
    setupActions: [],
  },
  {
    ...
    content: 'View past conversations and threads and organize them hierarchically for better context and retrieval.',
    setupActions: [
  ...
  },
  {
    ...
    targetId: 'canvas-area',
    title: 'Agent Canvas',
    content: 'The assistant will display longer text or image artifacts here, to avoid cluttering the main chat area below. With tabs, users can quickly switch between different artifacts from various threads.',
    setupActions: [
      selectPlugin('agent'),
    ],
  },
  ...
  // ========================================
  {
    ...
    content: 'A folder-based document store for document and knowledge management.',
    tooltipPosition: 'right',
  ...
  // ========================================
  {
    ...
    content: 'A tool to manage and keep track of your LLM prompt templates.',
    tooltipPosition: 'right',
  ...
  },
  {
    ...
    content: 'Create and manage your LLM prompts. Tip: Combine prompts with `usePrompt(\'label\')`',
    setupActions: [
  ...
  // ========================================
  {
    ...
    title: 'Flows Plugin',
    content: 'A drag-and-drop step editor tool to build and orchestrate your assistant’s behavior.',
    tooltipPosition: 'right',
  ...
  },
  {
    ...
    content: 'See a real-time execution graph of your flows. Select a trace node to view details and debug issues.',
    setupActions: [
      selectPlugin('brain'),
    ],
  },
  ...
  // ========================================
  {
    ...
    content: 'A place to configure the application to your preferences.',
    tooltipPosition: 'right',
  ...
  },
  {
    ...
    content: 'To finish getting setup, you will need to set some API keys. You can click an AI provider\'s name to go to their settings page and copy your keys. Keys are stored locally and are never shared.',
    setupActions: [
