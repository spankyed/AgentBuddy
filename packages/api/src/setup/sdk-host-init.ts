...
import * as settingsChangesMod from '@/core/shared/settings-changes';
...
import * as templateExecutorMod from '@/core/shared/template-executor';
import * as promptContextMod from '@/core/shared/prompt-context';
...
registerHostModule('settings-changes', settingsChangesMod);
...
registerHostModule('template-executor', templateExecutorMod);
registerHostModule('prompt-context', promptContextMod);
