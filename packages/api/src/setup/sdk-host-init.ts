...
import { eventTransport } from '@/core/router/event-transport';
...
import { registerHostServices } from '@abuddy/host/services';
...
// services.appData, services.traceStore, services.inference
